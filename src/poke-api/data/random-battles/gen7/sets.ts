export const sets = {
  ...
  "gardevoirmega": {
    ...
    "sets": [
      {
        "role": "Setup Sweeper",
        "movepool": ["calmmind", "encore", "focusblast", "hypervoice", "psyshock", "taunt", "willowisp"],
        "abilities": ["Trace"]
      },
      {
        "role": "Fast Attacker",
        "movepool": ["focusblast", "hypervoice", "psyshock", "substitute", "taunt", "willowisp"],
        "abilities": ["Trace"],
        "preferredTypes": ["Fighting"]
      }
    ]
  ...
  "carnivine": {
    ...
    "sets": [
      ...
      {
        "role": "Bulky Setup",
        "movepool": ["knockoff", "powerwhip", "swordsdance", "synthesis"],
        "abilities": ["Levitate"]
      }
    ]
  },
  ...
  "toxapex": {
    ...
    "sets": [
      {
        "role": "Bulky Support",
        "movepool": ["haze", "knockoff", "recover", "scald", "toxic", "toxicspikes"],
        "abilities": ["Regenerator"]
      },
      {
        "role": "Staller",
  ...
  "tapulele": {
    ...
    "sets": [
      ...
      {
        "role": "AV Pivot",
        "movepool": ["focusblast", "moonblast", "naturesmadness", "psychic", "psyshock"],
        "abilities": ["Psychic Surge"]
      }
    ]
  },
